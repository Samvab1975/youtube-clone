        ...
        <div>
            ...
            <div class="main-section">
                <div class="main-left">
                    ...
                    <button class="yt-side-button">
                        <MdOutlineSubscriptions /> <span class="side-button-label">Subscription</span>
                    </button>
                    <hr />
                    <button class="yt-side-button">
                        <LiaFileVideoSolid /> <span class="side-button-label">Shorts</span>
                    </button>
                    <button class="yt-side-button">
                        < BsFileMusic/> <span class="side-button-label">Music</span>
                    </button>
                    <button class="yt-side-button">
                        < MdOutlineHistory/> <span class="side-button-label">History</span>
                    </button>
                    <button class="yt-side-button">
                        < BiPurchaseTag/> <span class="side-button-label">Purchase</span>
                    </button>
                </div>
